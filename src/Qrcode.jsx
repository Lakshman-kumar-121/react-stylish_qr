...
const Qrcode = () => {
    ...
    const [url, setUrl] = useState("https://github.com/Lakshman-kumar-121");
    const [height, setHeight] = useState(300)
    const [width, setWidth] = useState(300)
    const [logo, setLogo] = useState("https://github.githubassets.com/assets/GitHub-Mark-ea2971cee799.png"); //https://upload.wikimedia.org/wikipedia/commons/5/51/Facebook_f_logo_%282019%29.svg
